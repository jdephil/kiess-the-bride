...
from kiess_the_bride.common import views as common_views
from kiess_the_bride.core import urls as core_urls
...
schema_view = get_schema_view(
    openapi.Info(
        title="kiess_the_bride API",
        default_version="1.0",
        description="kiess_the_bride Docs",
