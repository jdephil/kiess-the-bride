...
SERVER_EMAIL = config("DEFAULT_FROM_EMAIL", default="kiess_the_bride <noreply@kiess_the_bride.com>")
...
#
HEROKU_APP_NAME = config("HEROKU_APP_NAME", default="kiess_the_bride-staging")
...
INSTALLED_APPS = [
    # Local
    "kiess_the_bride.common",
    "kiess_the_bride.core",
    # Django
...
GRAPHENE = {
    "SCHEMA": "kiess_the_bride.core.schema.schema",
    "MIDDLEWARE": [
...
ROOT_URLCONF = "kiess_the_bride.urls"
...
TEMPLATES = [
    {
        ...
        "DIRS": [
            ...
            os.path.join(BASE_DIR, "kiess_the_bride", "client", "templates"),  # Swagger template override
        ],
...
WSGI_APPLICATION = "kiess_the_bride.wsgi.application"
...
REST_FRAMEWORK = {
    ...
    "DEFAULT_PAGINATION_CLASS": "kiess_the_bride.core.pagination.PageNumberPagination",
    "DEFAULT_AUTHENTICATION_CLASSES": [
        "kiess_the_bride.core.jwt_auth.JSONWebTokenAuthentication",
...
if config("USE_AWS_STORAGE", cast=bool, default=False) and not IS_REVIEW_APP:
    ...
    DEFAULT_FILE_STORAGE = "kiess_the_bride.utils.storages.PrivateMediaStorage"
    # STATICFILES_STORAGE = "kiess_the_bride.utils.storages.StaticRootS3Boto3Storage"
...
LOGGING = {
    ...
    "loggers": {
        ...
        "kiess_the_bride.request": {"handlers": [], "level": "INFO", "propagate": True},
        "kiess_the_bride.tasks": {"handlers": [], "level": "INFO", "propagate": True},
    },
}
...
if IN_PROD or ROLLBAR_ACCESS_TOKEN:
    ...
    LOGGING["loggers"]["kiess_the_bride"]["handlers"].append("rollbar")

# Popular testing framework that allows logging to stdout while running unit tests
TEST_RUNNER = "django_nose.NoseTestSuiteRunner"

CORS_ALLOWED_ORIGINS = ["https://kiess-the-bride-staging.herokuapp.com", "https://kiess-the-bride.herokuapp.com"]
