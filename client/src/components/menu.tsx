...
export default function MyMenu() {
  return (
    <div className="fixed top-8 w-20 text-right md:top-14  md:w-36 ">
      <Menu as="div" className="relative inline-block text-left">
        <div>
          <Menu.Button className="inline-flex w-full justify-center rounded-md bg-[#232F2C] px-2 py-1 text-white hover:bg-black/30  focus:outline-none focus-visible:ring-2 focus-visible:ring-white/75 md:px-4 md:py-2">
            <Bars3Icon
